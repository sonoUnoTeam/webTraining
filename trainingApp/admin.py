...
class TrainingBlockAdmin(PaginationMixin, TranslationAdmin, admin.ModelAdmin):
...
class TrainingQuestionAdmin(PaginationMixin, TranslationAdmin, admin.ModelAdmin):
...
class TrainingQuestionAnswerAdmin(PaginationMixin, ExportActionMixin, admin.ModelAdmin):
    resource_class= TrainingQuestionAnswerResource
...
class TrainingBlockAnswerAdmin(PaginationMixin, admin.ModelAdmin):
...
class TraineeGroupAdmin(PaginationMixin, admin.ModelAdmin):
    list_display = ('id','name_group','description')
    search_fields = ('name_group',)


class CourseTrainingAdmin(PaginationMixin, admin.ModelAdmin):
    list_display = ('id', 'course', 'training', 'order')
    list_filter = ('course', 'training')
    search_fields = ('course__name_course', 'training__name_training')
    ordering = ('course', 'order')


class CourseAdmin(PaginationMixin, TranslationAdmin, admin.ModelAdmin):
    list_display = ('id', 'name_course', 'view_trainings', 'state_course', 'pub_date')
...
class TraineeCourseAdmin(PaginationMixin, admin.ModelAdmin):
